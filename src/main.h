...
static const int64 MAX_MONEY = 200000000 * COIN; // HQCoin: No current maximum.  This may have to be fiddled with later.
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1000 / 250; // HQCoin: 1000 blocks found a day. Priority cutoff is 1 hqcoin day / 250 bytes.
    }
